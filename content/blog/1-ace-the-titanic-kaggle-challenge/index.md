...
date: 2016-08-10 10:10:00 # YYYY-MM-DD - H:M:S
author: Ahmed BESBES
tags: ['kaggle', 'titanic challenge', 'data science', 'competition', 'tutorial', 'classification']
---
...
This tutorial is available on my github [repo](https://github.com/ahmedbesbes/How-to-score-0.8134-in-Titanic-Kaggle-Challenge) from which you'll find a notebook version of this post.
...
In this section, we'll be doing four things.
  ...
  3. Assumptions : we'll formulate hypotheses from the charts.
...
You will notice that each name has a title in it ! This can be a simple Miss. or Mrs. but it can be sometimes something more sophisticated like Master, Sir or Dona. In that case, we might introduce an additional 
information about the social status by simply parsing the name and extracting the title and converting to a binary variable.
...
You can learn about dummy coding and how to easily do it in Pandas [here](http://pandas.pydata.org/pandas-docs/stable/generated/pandas.get_dummies.html).
...
In this article, we explored an interesting dataset brought to us by [Kaggle](http://kaggle.com/).
...
This post can be downloaded as a notebook if you ever want to test and play with it : my github [repo](https://github.com/ahmedbesbes/post1/blob/master/titanic-article.ipynb).
...
As a word of gratitude, I would like to thank [Kdnuggets](https://twitter.com/kdnuggets/status/765636511492612096?ref_src=twsrc%5Etfw%7Ctwcamp%5Etweetembed%7Ctwterm%5E765636511492612096&ref_url=https%3A%2F%2Fahmedbesbes.com%2Fhow-to-score-08134-in-titanic-kaggle-challenge.html) for sharing this post !


<div>
  <blockquote class="twitter-tweet"><p lang="en" dir="ltr">How to score 0.8134 in <a href="https://twitter.com/hashtag/Titanic?src=hash&amp;ref_src=twsrc%5Etfw">#Titanic</a> <a href="https://twitter.com/kaggle?ref_src=twsrc%5Etfw">@Kaggle</a> Challenge <a href="https://t.co/YQwJN4JjUT">https://t.co/YQwJN4JjUT</a> <a href="https://twitter.com/hashtag/MachineLearning?src=hash&amp;ref_src=twsrc%5Etfw">#MachineLearning</a> <a href="https://t.co/QQrXO5p0p3">pic.twitter.com/QQrXO5p0p3</a></p>&mdash; KDnuggets (@kdnuggets) <a href="https://twitter.com/kdnuggets/status/765636511492612096?ref_src=twsrc%5Etfw">August 16, 2016</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
</div>